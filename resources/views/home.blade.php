...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/img/softweblogo.png') }}" rel="icon">
    <link href="{{ asset('assets/img/softweblogo.png') }}" rel="apple-touch-icon">
...
<body>
  ...
  <img src="{{ asset('assets/img/banners/log_bg.png') }}" alt="">
    <!-- ======= Top Bar ======= -->
    ...
    <header id="header">
        <div class="container">
            <div class="logo float-left">
                <h1 class="text-light">
                    <a href="index.html">
                        <img src="assets/img/softweblogo.png" alt="">
                        <!-- <span>
              Mamba
            </span> -->
                    </a>
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content container">
                                ...
                                <p class="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea
                                    ut et est
                                    quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea
                                    voluptatem. Esse
                ...
                <div class="row  d-flex align-items-stretch">
                    ...
                    <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <p>
                            ...
                            malesuada nunc
                            vel. Tincidunt eget nullam non nisi est sit amet. Turpis nunc eget lorem dolor sed. Ut
                            venenatis tellus in
